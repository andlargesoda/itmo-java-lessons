package ru.itmo.lessons.lesson21.anonymous;
...
public class Anonymous {
    public static void main(String[] args) {
        ...
        int a = 90;
        // анонимный не статический класс
        clear.setAction(new Clickable() {
            @Override
            public void click() {
                int a = 10; // локальные переменные затеняют свойства внешнего класса и локальные переменные внешнего метода
        ...
        Clickable sendAction = new Clickable() { // class Send implements Clickable {} // тело класса без имени
            @Override
            public void click() {
