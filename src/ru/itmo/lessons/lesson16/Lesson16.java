...
public class Lesson16 {
    ...
    // все static загружаются в память один раз
    static { // static блок
    ...
    // под main выделяется кусок стек памяти
    public static void main(String[] args) {
        // со
        // под
        DevelopingClass defaultObj = DevelopingClass.getDefault();
        // под метод minusValue выделяется память и объявляется переменная int value
